            ...
            <View style={[style.callContainerStyle]}>
                ...
                <View>
                  ...
                  {incomingCall.type === 'video' ? (
                    <View style={style.callTypeStyle}>
                      <Image source={videoCallIcon} alt="Appel vidéo entrant" />
                    ...
                    <View style={style.callTypeStyle}>
                      <Image source={audioCallIcon} alt="Appel audio entrant" />
                      <View style={style.callMessageContainerStyle}>
                        <Text
                          numberOfLines={1}
                          style={style.callMessageTextStyle}>
              ...
              <View style={style.headerButtonStyle}>
                <TouchableOpacity
                  ...
                  onPress={rejectCall}>
                  <Text style={style.btnTextStyle}>Refuser</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[
                    style.buttonStyle,
                  ...
                  onPress={acceptCall}>
                  <Text style={style.btnTextStyle}>Accepter</Text>
                </TouchableOpacity>
              </View>
            </View>
          </SafeAreaView>
